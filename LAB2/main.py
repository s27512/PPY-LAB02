...
Original file is located at
    https://colab.research.google.com/drive/1KgPuFtCUF-aEIZ5EsjmECR7eEFhcgIEC
...
if 8 in numbers_list:  # Remove the element 8
...
set1 = {1, 2, 5, 9, 10}
set2 = {5, 8, 11, 12}
set_union = set1.union(set2)  # Union
set_intersection = set1.intersection(set2)  # Intersection
set_difference = set1.difference(set2)  # Difference
...
numbers_set.add(10)
numbers_set.remove(8)

# Dictionary Operations
numbers_dict = {num: num ** 2 for num in numbers}
print("Original Dictionary:", numbers_dict)
numbers_dict[10] = 100  # Add a new key-value pair

if 1 in numbers_dict:
    del numbers_dict[1]  # Delete an existing key-value pair
else:
    print("Key '1' not found in dictionary.")

# Type Conversion
list_to_tuple = tuple(numbers) # list_to_tuple
list_to_set = set(numbers) # list_to_set
list_to_dict = {num: num ** 2 for num in numbers} # list_to_dict

tuple_to_list = list(numbers_tuple) # tuple_to_list
tuple_to_set = set(numbers_tuple) # tuple_to_set
tuple_to_dict = {num: num ** 2 for num in numbers_tuple} # tuple_to_dict

set_to_list = list(numbers_set) # set_to_list
set_to_tuple = tuple(numbers_set) # set_to_tuple
set_to_dict = {num: num ** 2 for num in numbers_set} # set_to_dict

dict_to_list = list(numbers_dict.keys()) # dict_to_list
dict_to_tuple = tuple(numbers_dict.keys()) # dict_to_tuple
dict_to_set = set(numbers_dict.keys()) # dict_to_set
...
num_integers = sum(line.count(" ") + 1 for line in lines)
